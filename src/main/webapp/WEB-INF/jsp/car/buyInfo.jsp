	...
	function init(){
		datagrid = $('#tt').datagrid({
			...
			detailFormatter: function(rowIndex, rowData){
				...
				//alert(s2);
				return '<table><tr>' +
						'<td rowspan=2 style="border:0"><img src="${s2}/uploadImage/' + rowData.imag + '.png" style="height:150px;"></td>' +
						'<td style="border:0">' +
		...
		<div title="车辆信息" data-options="region:'north'" style="height: 100px">
			<form id="searchForm">
				<table cellpadding="5">
					...
					<tr>
						<td>起始价格:</td>
						<td><input class="easyui-textbox" type="text" id="startPrice"
							name="startPrice"></input></td>
						<td>最高价格:</td>
						<td><input class="easyui-textbox" type="text" id="endPrice"
							name="endPrice"></input></td>
						<td>破损度:</td>
						...
						<td><a href="#" id="btn_search" class="easyui-linkbutton"
