...
<body style="padding: 0 4px; margin: 0; overflow: hidden;">
	<div class="easyui-layout" style="width: 100%; height: 100%;"
		...
		<div id="dd" title="My Dialog"
			style="width: 800px; height: 450px; text-align: left;"
			...
			<form id="ff" method="post" action="${ctx}/sale/saveCar.do">
				...
				<table cellpadding="3">
					<tr>
						<td>车型:</td>
						<td><input class="easyui-textbox" type="text" id="carType"
							name="carType" data-options="required:true" /></td>
						<td>车显里程:</td>
						<td><input class="easyui-textbox" type="text" id="mileage"
							name="mileage" data-options="required:true" /></td>
						<td>价位:</td>
					...
					<tr>
						<td>购买几年:</td>
						<td><input class="easyui-textbox" type="text" id="old"
							name="old" data-options="required:true"></input></td>
						<td>经销商:</td>
						<td><input class="easyui-textbox" type="text" id="agency"
							name="agency" data-options="required:true" /></td>
						<td>颜色:</td>
						<td><input class="easyui-textbox" type="text" id="color"
							name="color" data-options="required:true"></input></td>
					</tr>
					<tr>
						<td>破损度:</td>
						<td><select style="width: 150px" class="easyui-combobox"
							id="damaged" name="damaged" data-options="required:true">
