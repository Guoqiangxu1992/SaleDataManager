...
<body style="padding: 0 4px; margin: 0; overflow: hidden;">
	<div class="easyui-layout" style="width: 100%; height: 100%;"
		...
		<div data-options="region:'center'"
			style="width: 400px; padding: 50px 200px;">
			<div class="easyui-panel" title="个人信息" style="width: 700px;">
				<form id="ff" method="post" action="${ctx}/user/modify.do">
					<input class="easyui-textbox" type="hidden" id="markImag"
						name="markImag" /> <input class="easyui-textbox" type="hidden"
					...
					<table cellpadding="2" class="editTable">
						<tr>
							...
							<td><input class="easyui-textbox" id="userName"
								name="userName" data-options="required:true" readonly="readonly" />
							<td>性别:</td>
							<td><input class="easyui-combobox" type="text" id="sex"
								name="sex" data-options="required:true" />
						</tr>

						<tr>
							<td>姓名:</td>
							<td><input class="easyui-textbox" id="fullName"
								name="fullName" data-options="required:true" />
							<td>密码:</td>
							<td height="100px;"><input class="easyui-textbox"
								id="passWord" name="passWord" data-options="required:true" /></td>
							<td>出生日期:</td>
							<td><input class="easyui-datebox" type="text" id="birthday"
								name="birthday" data-options="required:true" /></td>
						</tr>
						<tr>
