...
<script type="text/javascript">
	...
	$(function(){
		datagrid=$("#dg").datagrid({
			url:"${ctx}/user/sale/list.do",//加载的URL
		    isField:"id",	
			...
			toolbar:[              //工具条
			        	...
			        	else
			        	{
			        		$.messager.confirm('确定','您确定要删除吗',function(t){
			        			if(t)
			        			{
			        				...
			        				$.ajax({
			        					url : '${ctx}/user/sale/deleteMore.do',
			        					data : 'ids='+ids.join(','),
			        					method: 'POST',
			        					dataType : 'text',
			        					success : function(r) {
			        ...
			        {text:"修改",iconCls:"icon-edit",handler:function(){
			        	...
			        	{
			         		$.ajax({
			    				url : '${ctx}/user/sale/id'+rows[0].id+'.do',
			    				dataType : 'json',
			    				success : function(r) {
			    					if (r.id) {
			    						$('#dd').dialog('open');
...
<body style="padding: 0 4px; margin: 0; overflow: hidden;">
	<div class="easyui-layout" style="width: 100%; height: 100%;"
		...
		<div title="商家管理" data-options="region:'north'" style="height: 100px">
			<form id="searchForm">
				<table cellpadding="5">
					<tr>
						<td>姓名:</td>
						<td><input class="easyui-textbox" type="text"
							id="fullNameSearch" name="fullName"></input></td>
		...
		<div id="dd" title="My Dialog"
			...
			<form id="ff" method="post" action="${ctx}/user/sale/saveSale.do">
