...
<script src="${ctx}/js/easyui/easyui-validate-extend.js"
	type="text/javascript"></script>
<script src="${ctx}/js/myfun.js" type="text/javascript"></script>
<script src="${ctx}/js/slider.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery.cookie.js" type="text/javascript"></script>

<link href="${ctx}/js/easyui/themes/default/easyui.css" rel="stylesheet"
	type="text/css" />
