...
<body>
					...
					<div style="padding: 10px 60px 20px 60px">
						...
						<div style="text-align: center; padding: 10px; margin-top: 20px;">
							<a href="javascript:void(0)" class="easyui-linkbutton"
								onclick="submitForm()">确&nbsp;定</a> <a href="javascript:void(0)"
								class="easyui-linkbutton" onclick="clearForm()">清&nbsp;除</a> <a
	...
	/* 	function submitForm(){
		...
		function register(){
			top.window.location="${ctx}/register.jsp";
		}
	</script>
